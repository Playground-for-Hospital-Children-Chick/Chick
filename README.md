...
| 이름                                                                      | 개발 내용                                                                                                                                   |
| ------------------------------------------------------------------------- | ------------------------------------------------------------------------------------------------------------------------------------------- |
| [👨🏻‍💻 최정온](readme_photo/choijeongon.png) [📧](mailto:chjo0330@gmail.com) | 팀장, 프론트 리더 <br /> React, Socket.io(client), WebRTC<br />웹사이트 전체 디자인 및 UI/UX 기획 <br /> 웹소켓 게임 기능 <br /> UCC <br /> |
| [👨🏻‍💻 엄희원](readme_photo/eomheewon.png) [📧](mailto:eomtiger@gmail.com)   | React, WebRTC <br /> 게임방 페이지 구현                                                                                                     |
| [👨🏻‍💻 김민준](readme_photo/kmj.png) [📧](mailto:gofiction95@gmail.com)      | React <br /> 마이 페이지, 로그인, 회원가입 및 회원 관리 페이지 구현                                                                         |

#### 🛰벡엔드

| 이름                                                                  | 개발 내용                                                                                              |
| --------------------------------------------------------------------- | ------------------------------------------------------------------------------------------------------ |
| [👨🏻‍💻 한재욱](readme_photo/hju.png) [📧](mailto:hju9707@gmail.com)      | Spring Boot REST API<br />Socket.io(server)<br /> 웹소켓 게임 기능 <br /> 젠킨스와 도커를 활용한 CI/CD |
| [👨🏻‍💻 김주성](readme_photo/kjs.png) [📧](mailto:kjschocolate@gmail.com) | Spring Boot REST API<br /> 자동 매칭 알고리즘 <br /> 젠킨스와 도커를 활용한 CI/CD                      |
...
![ERD](readme_photo/ERD.png)
<br>

### 🧩와이어프레임

![피그마](readme_photo/figma.png)
...
| 🖼프론트엔드                                             | 📡백엔드                                               |
| ------------------------------------------------------- | ------------------------------------------------------ |
| ![프론트디렉토리구조](readme_photo/front_directory.png) | ![벡엔드디렉토리구조](readme_photo/back_directory.png) |

<br>

### 📢Jira

![지라](readme_photo/jira.png)

<br>

### 🧾Notion

![노션](readme_photo/notion.png)
...
![변신놀이](readme_photo/transition.png)
<br>

#### 그림놀이

![그림놀이](readme_photo/drawing.png)
<br>

#### 율동놀이

![율동놀이](readme_photo/yuldong.png)
<br>

#### 만화보기

![만화](readme_photo/cartoon.png)
<br>

#### 마이페이지

![마이페이지](readme_photo/mypage.png)
<br>
...
![image](readme_photo/demo_test.png)
