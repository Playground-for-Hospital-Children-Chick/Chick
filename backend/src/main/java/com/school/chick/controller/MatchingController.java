...
public class MatchingController {
    ...
    @PostMapping("/")
    @ApiOperation(value = "매칭방 입장", notes = "매칭방에 입장합니다")
    @ApiResponses({
    ...
    public ResponseEntity<BaseResponseBody> register(@RequestBody @ApiParam(value = "대기방 입장", required = true) MatchingReq registerInfo) {
        if (matchingService.createMatching(registerInfo)) {
