...
CREATE TABLE `auth_refresh_save` (
  ...
  `auth_create_by` varchar(255) DEFAULT NULL,
  `auth_create_date` datetime(6) DEFAULT NULL,
  `auth_email` varchar(255) DEFAULT NULL,
  `auth_update_by` varchar(255) DEFAULT NULL,
  `auth_update_date` datetime(6) NOT NULL,
